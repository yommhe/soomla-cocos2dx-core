...
soomla::CCSchedule::CCDateTimeRange *soomla::CCSchedule::CCDateTimeRange::create(timeval start, timeval end) {
...
bool soomla::CCSchedule::CCDateTimeRange::init(timeval start, timeval end) {
    mStart = start;
    mEnd = end;
...
bool soomla::CCSchedule::CCDateTimeRange::initWithDictionary(cocos2d::__Dictionary *dict) {
    Ref *ref;
    time_t seconds;
...
soomla::CCSchedule::CCDateTimeRange::~CCDateTimeRange() {

}

cocos2d::__Dictionary *soomla::CCSchedule::CCDateTimeRange::toDictionary() {
...
soomla::CCSchedule *soomla::CCSchedule::create(cocos2d::__Integer *requiredRecurrence, cocos2d::__Array *timeRanges, cocos2d::__Integer *activationLimit) {
...
CCSchedule *soomla::CCSchedule::create(cocos2d::__Integer *activationLimit) {
    return CCSchedule::create(cocos2d::__Integer::create(CCSchedule::Recurrence::NONE), NULL, activationLimit);
}

CCSchedule *soomla::CCSchedule::create(cocos2d::__Integer *requiredRecurrence, timeval start, timeval end, cocos2d::__Integer *activationLimit) {
...
CCSchedule *soomla::CCSchedule::createAnyTimeOnce() {
    return CCSchedule::create(cocos2d::__Integer::create(1));
}

CCSchedule *soomla::CCSchedule::createAnyTimeLimited(int activationLimit) {
    return CCSchedule::create(cocos2d::__Integer::create(activationLimit));
}

CCSchedule *soomla::CCSchedule::createAnyTimeUnLimited() {
    return CCSchedule::create(cocos2d::__Integer::create(0));
}

bool soomla::CCSchedule::init(cocos2d::__Integer *requiredRecurrence, cocos2d::__Array *timeRanges, cocos2d::__Integer *activationLimit) {
...
bool soomla::CCSchedule::initWithDictionary(cocos2d::__Dictionary *dict) {
...
bool soomla::CCSchedule::approve(int activationTimes) {
